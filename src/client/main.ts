import { ApiError, createHabit, listHabits, setEntry, type Habit } from "./api.js";
...
const addButton = document.getElementById("add-habit-button") as HTMLButtonElement;
const addError = document.getElementById("add-habit-error") as HTMLParagraphElement;
...
function habitRow(habit: Habit): HTMLLIElement {
